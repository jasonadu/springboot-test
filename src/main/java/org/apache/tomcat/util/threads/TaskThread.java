...
public class TaskThread extends Thread {
    ...
    public TaskThread(ThreadGroup group, Runnable target, String name) {
        super(group, new WrappingRunnable(target), name); //target=java.util.concurrent.ThreadPoolExecutor$Worker@70331432[State = -1, empty queue], name=http-nio-8080-exec-1
